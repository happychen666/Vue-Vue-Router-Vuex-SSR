...
const config = {
  ...
  module: {
    //因为webpack只能处理js和json文件,且只识别ES5的语法
    rules: [
      {
        test: /\.(vue|js|jsx)/,
      ...
      // },
      {
        test: /\.js$/, // 这里的loader js和jsx loader是分开来写的，因为js loader要忽略掉node_modules里面的文件，node_modules里面其实页都是js文件，它们在发布的时候就已经编译过了，所以这里单独要把node_modules去掉
        loader: 'babel-loader',
        exclude: /node_modules/,
      },
      {
        ...
        use: [
          {
            ...
            options: {
              ...
              name: 'resources/[path][name].[hash].[ext]', //这里可以将静态文件打包到单独的文件中//输出文件的名字,[name] 文件原名,[ext]文件扩展名.
            },
          },
        ],
      },
